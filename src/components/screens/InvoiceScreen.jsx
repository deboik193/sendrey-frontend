...
export const InvoiceScreen = ({
  ...
  const invoice = invoiceData ? {
    ...
    items: [
      { name: "Sub Total", amount: invoiceData.subTotal || 0 },
      { name: "VAT", amount: invoiceData.vatTotal || 0 },
    ],
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            <div className={`relative w-full max-w-md rounded-t-3xl overflow-hidden ${darkMode ? "bg-gray-400/50" : "bg-white"
              ...
              <div className={`p-5 pb-4 border-b flex justify-center items-center ${darkMode ? "border-gray-800" : "border-gray-200"
                ...
                <h2 className={`text-xl font-bold ${darkMode ? "text-gray-200" : "text-black"}`}>
              ...
              <div className="p-4">
                <div className="mb-3 flex flex-col items-center justify-center gap-1">
                  <p className={`text-md font-semibold ${darkMode ? "text-primary" : "text-primary"}`}>
                    Runner: {runner?.firstName || ''} {runner?.lastName || ''}
                  </p>
                  <p className={`text-xs ${darkMode ? "text-primary" : "text-primary"}`}>
                ...
                <div className={`rounded-lg overflow-hidden ${darkMode ? "bg-gray-800" : "bg-gray-50"}`}>
                  <div className={`grid grid-cols-12 gap-2 p-3 text-xs font-semibold border-b ${darkMode ? "border-gray-700 text-gray-200" : "border-gray-200 text-gray-600"
                    }`}>
        ...
        <>
          ...
          <div className="fixed inset-0 z-[70] flex items-center justify-center p-4">
            <div className={`relative w-full max-w-sm rounded-2xl p-6 ${darkMode ? "bg-gray-900" : "bg-white"
              ...
              <p className={`text-sm mb-6 text-center ${darkMode ? "text-gray-400" : "text-gray-600"
                }`}>
